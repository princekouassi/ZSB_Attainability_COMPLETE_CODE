...
y_fp = visual.TextStim(win, text=y_fpi,pos=(14, -3), height=textsize, wrapWidth=40,alignHoriz = 'center')
# Neighbour fund performance text:
n_fpi = '''Fund Performance'''
n_fp = visual.TextStim(win, text=n_fpi,pos=(-14, -3), height=textsize, wrapWidth=40,alignHoriz = 'center')
# Your fund performance PROFIT:
y_fund_profi = '''PROFIT'''
y_fund_prof = visual.TextStim(win, text=y_fund_profi,pos=(14, -1), height=1.5, wrapWidth=40,alignHoriz = 'center',color='green')
# Neighbour fund performance PROFIT:
n_fund_profi = '''PROFIT'''
n_fund_prof = visual.TextStim(win, text=n_fund_profi,pos=(-14, -1), height=1.5, wrapWidth=40,alignHoriz = 'center',color='green')
# Your fund performance LOSS:
y_fund_lossi = '''LOSS'''
y_fund_loss = visual.TextStim(win, text=y_fund_lossi,pos=(14, -1), height=1.5, wrapWidth=40,alignHoriz = 'center',color='red')
# Neighbour fund performance LOSS:
n_fund_lossi = '''LOSS'''
n_fund_loss = visual.TextStim(win, text=n_fund_lossi,pos=(-14, -1), height=1.5, wrapWidth=40,alignHoriz = 'center',color='red')
########################################################################################
...
for i in range(15): # Number of trials
    ...
    while trial == True: # while loop to show static market performance grid
        ...
        win.flip()
        core.wait(0.1) # Keep each market number on screen for x seconds
        break
