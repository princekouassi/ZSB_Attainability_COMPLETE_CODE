...
########################################################################################
def show_fund_res(last_left,last_right):
    ...
    left_market_numi = left_market0[14] # Identify what number to show for your market
    left_market_num = visual.TextStim(win, text=left_market_numi,pos=(-14, 7), height=textsize, wrapWidth=40,alignHoriz = 'center')
    left_market_num.draw()# Show your market number
    right_market_numi = right_market0[14] # Identify what number to show neighbour market
    right_market_num = visual.TextStim(win, text=right_market_numi,pos=(14, 7), height=textsize, wrapWidth=40,alignHoriz = 'center')
    right_market_num.draw()# Show the neighbour market number
    y_fund.draw()
    c_fund.draw()
...
# Define last number shown on each fund:
...
# Call function to show fund perforamnce and que responses:
show_fund_res(last_left,last_right)
